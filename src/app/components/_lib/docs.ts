...
export const componentDocs: ComponentDoc[] = [
  ...
  },
  {
    ...
    description:
      "Preview wraps component demos in a single, consistent frame with two tabs: live preview and code. It is designed for docs pages where examples should stay centered, readable, and easy to copy.",
    installation: {
    ...
    a11y: [
      ...
      "Use clear tab labels and ARIA roles for preview/code switching.",
